...
# keep following through 2021 example; hopefully simplify, goal: format as 2021 export
...
# some RM 0 site_id and sample_id are not appearing after join. unclear why


z <- data.frame(unique(sgs_sitenames$site_id))

z1 <- data.frame(unique(sgs23$site_id))

z2 <- data.frame(unique(sgs23$sample_id))
