...
# for 2023, we need to consolidate "ug/l" and "ug/L"
dat %<>%
  mutate(result_unit = case_when(
...
In the field, all samples were stored in coolers with ice packs at 4 degrees C until arrival at the laboratory. 
...
# see: extensive limitations won what values can be used for RPD purposes; EPA metals guidance doc

# WORKING HERE 3/15/2024

# join tables and calculate RPDs
dup_diffs <- left_join(dup_vals1,dup_vals2) %>%
  mutate(pct_diff = dup_)
