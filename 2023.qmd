...
# Designate abbreviations for filtration status (from Result Sample Fraction)
z <- sgs23 %>%
  mutate(sample_fraction_abbrv = 
           
           )

# WORKING HERE 2/1/2024

# note that surrogate organic compunds ("surr" suffix) do not have analyte abbreviations; becuase they are not project analytes


# Designate abbreviations for analytes
# Import matching table

# analytes <- data.frame(unique(sgs23$analyte))
# write.csv(analytes,"other/input/2023/misc/analytes.csv", row.names = F)
