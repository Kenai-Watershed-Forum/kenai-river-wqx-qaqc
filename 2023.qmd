...
```{r echo = F}
z <- dat %>%
  group_by(activity_start_date,activity_type,characteristic_name,result_analytical_method_id) %>%
  count()

# WORKING HERE 2/26/24

# need to fix: for method 200.8, result_analytical_method_id and result_analytical_method_context
